...
class truck extends CI_Controller{
	...
	function form_action($is_delete = 0){
		...
		$data['truck_code'] 				= $this->input->post('i_code');
		$data['truck_name'] 				= $this->input->post('i_name');
		$data['truck_leader'] 				= $this->input->post('i_leader');
		$data['truck_description'] 			= $this->input->post('i_description');
		$data['truck_phone'] 				= $this->input->post('i_phone');
		$data['truck_address'] 				= $this->input->post('i_address');
