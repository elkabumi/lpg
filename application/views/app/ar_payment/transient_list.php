...
$(function(){
	createTableFormTransient({
		id 				: "#transient_list",
		listSource 		: "ar_payment/detail_list_loader_bayar/<?=$row_id?>",
		formSource 		: "ar_payment/detail_form/<?=$row_id?>",
		controlTarget	: "ar_payment/detail_form_action",
...
<div>
<form id="tform">
<table cellpadding="0" cellspacing="0" border="0" class="display" id="transient_list"> 
	<thead>
		<tr>
