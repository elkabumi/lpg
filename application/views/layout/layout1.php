...
<link href="<?=base_url()?>assets/css/new_css/iCheck/all.css" rel="stylesheet" type="text/css" />
...
<!-- Bootstrap -->
<script src="<?=base_url()?>assets/js/new_js/bootstrap.min.js" type="text/javascript"></script>
 <!-- InputMask -->
 <script src="<?=base_url()?>assets/js/new_js/plugins/input-mask/jquery.inputmask.js" type="text/javascript"></script>
 <script src="<?=base_url()?>assets/js/new_js/plugins/input-mask/jquery.inputmask.date.extensions.js" type="text/javascript"></script>
        <script src="<?=base_url()?>assets/js/new_js/plugins/input-mask/jquery.inputmask.extensions.js" type="text/javascript"></script>
  ...
  <body class="skin-blue" >
        ...
        <header class="header">
            <a href="<?=base_url()?>" class="logo">
               ...
               <span style="font-size: 24px; font-weight: bold; color: white;">LPG</span>
<br/>
<span style="font-weight: bold; color: rgb(0, 255, 255)">Warehouse</span>
